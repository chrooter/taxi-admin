...
public class OrderVO implements Serializable {
	...
	public OrderVO(Integer id, Integer cost, String phone, Integer distance, Integer passengers, Timestamp timeDone, Timestamp timeOrd, Integer startPoint, Integer carId, String status,CarVO carVO) {
		this.id = id;
		this.cost = cost;
		this.phone = phone;
