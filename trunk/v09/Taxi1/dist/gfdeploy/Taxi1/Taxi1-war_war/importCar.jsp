					...
					<div class="box txt_wrap">
						<div class="txt pr zoom after">
							...
							<div class="txt_content">
								...
								<p class="create_test">
										<a href="<%=request.getContextPath()%>/CreateOrUpdateCar"><img alt="Импорт" src="<%=request.getContextPath()%>/i/save.jpg"/></a>
				...
				$('.open_b_div_link').live('click', function() {
					...
					buttons.addClass('close_b_div_link');
                        ...
                        <c:if test="${!empty requestScope.error}">
                            if (confirm('Импортировать с заменой?')) { parent.location='<%=request.getContextPath()%>/CreateOrUpdateCar?update=true'; }
