					...
					<div class="box txt_wrap">
						<div class="txt pr zoom after">
							...
							<div class="txt_content">
								<form action="<%=request.getContextPath()%>/CreateOrder" method="POST" accept-charset="UTF-8">
									...
									<div class="edit_box"><div class="box">
										...
										<div class="fl edit_side1">
												...
												<div class="box"><input type="text" class="db edit_txt" name="point${status.count}" maxlength="255" id="addrdep" value="${pointVO.address}"/></div>
                                                                                        ...
                                                                                        <div class="edit_side_block">
                                                                                            <button formaction="<%=request.getContextPath()%>/AddPoint" formmethod="POST" name="from" value="create">
                                                                                                    <img src="<%=request.getContextPath()%>/i/add.png" />Добавить адрес</button>
                                                                                            <c:if test="${fn:length(requestScope.chain) gt 2}"><button formaction="<%=request.getContextPath()%>/DeletePoint" formmethod="POST" name="from" value="create">
                                                                                                    <img src="<%=request.getContextPath()%>/i/delete.png" />Удалить адрес</button></c:if>
                                                                                        </div>
											<div class="edit_side_block">
										...
										<div class="box edit_side2">
											...
											<div class="edit_side_block">
												...
												<div class="box"><input readonly="readonly" type="text" class="db edit_txt" name="timeord" maxlength="6" id="timeOrd" value="<fmt:formatDate value="${requestScope.order.timeOrd}" type="both" dateStyle="short" timeStyle="short"/>"/></div>
											</div>
											<div class="edit_side_block">
