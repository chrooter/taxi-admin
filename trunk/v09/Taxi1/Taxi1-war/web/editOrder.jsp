							...
							<div class="txt_content">
								<form action="<%=request.getContextPath()%>/EditOrder" method="POST" accept-charset="UTF-8">
									<input type="hidden" name="id" value="${requestScope.order.id}"/>
                                                                        ...
                                                                        <input type="hidden" name="carTypeId" value="${requestScope.order.car.carTypeId}"/>
									...
									<div class="edit_box"><div class="box">
										...
										<div class="fl edit_side1">
											...
											<div class="edit_side_block">
                                                                                            <button formaction="<%=request.getContextPath()%>/AddPoint" formmethod="POST" name="from" value="edit">
                                                                                                    <img src="<%=request.getContextPath()%>/i/add.png" />Добавить адрес</button>
                                                                                            <c:if test="${fn:length(requestScope.chain) gt 2}"><button formaction="<%=request.getContextPath()%>/DeletePoint" formmethod="POST" name="from" value="edit">
