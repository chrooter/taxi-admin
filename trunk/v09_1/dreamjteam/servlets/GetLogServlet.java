...
import ru.dreamjteam.session.LogSessionBeanRemote;
import ru.dreamjteam.session.LogSessionBeanRemoteHome;
import ru.dreamjteam.binds2.*;
import session.*;
...
public class GetLogServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
           ...
           //LogSessionBeanRemote ptl = lookupfromLogLocal();
    ...
    private fromLogLocal lookupfromLogLocal() throws RemoteException {
        try {
...
//           Object remote = ic.lookup("LogSessionBean");
//           LogSessionBeanRemoteHome rv = (LogSessionBeanRemoteHome) PortableRemoteObject.narrow(remote, LogSessionBeanRemote.class);
//           return rv.create();
