					...
					<div class="box txt_wrap">
						<div class="txt pr zoom after">
							<div class="zoom after pr menu1">
								...
								<div class="menu1_active fl"><div class="menu1_activ_wrap"><div class="menu1_active_inner"><div class="menu1_active_div">Импорт машин</div></div></div></div>
							</div>
							<div class="txt_content">
								...
								<c:if test="${!empty requestScope.output}">
                                                                ...
                                                                <p class="create_test">
										<a href="<%=request.getContextPath()%>/CreateOrUpdateCarType"><img alt="Импорт" src="<%=request.getContextPath()%>/i/save.jpg"/></a>
