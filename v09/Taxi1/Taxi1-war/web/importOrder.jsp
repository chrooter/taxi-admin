					...
					<div class="box txt_wrap">
						<div class="txt pr zoom after">
							<div class="zoom after pr menu1">
								<div class="menu1_active fl"><div class="menu1_activ_wrap"><div class="menu1_active_inner"><div class="menu1_active_div">Импорт заявок</div></div></div></div>
							...
							<div class="txt_content">
								...
								<c:if test="${!empty requestScope.output}">
                                                                ...
                                                                <p class="create_test">
										<a href="<%=request.getContextPath()%>/CreateOrUpdateOrder"><img alt="Импорт" src="<%=request.getContextPath()%>/i/save.jpg"/></a>
				...
				$('.open_b_div_link').live('click', function() {
					...
					buttons.addClass('close_b_div_link');
                        ...
                        <c:if test="${!empty requestScope.error}">
                            if (confirm('Импортировать с заменой?')) { parent.location='<%=request.getContextPath()%>/CreateOrUpdateOrder?update=true'; }
                            else { parent.location='<%=request.getContextPath()%>/CreateOrUpdateOrder?update=false'; }
                        </c:if>
		</script>
	</body>
</html>