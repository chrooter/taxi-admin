								...
								<table class="c_table b_table">
									...
									<tbody>
										<tr>
											...
											<th><div class="th_div b_div">Телефон клиента<a href="<%=request.getContextPath()%>/ViewOrderList?field=ID&type=<%=type%>" class="b_div_link <%=sort%>" title="Сортировка"></a></div></th>
                                                                                        <th><div class="b_div">Статус<a href="<%=request.getContextPath()%>/ViewOrderList?field=ID&type=<%=type%>" class="b_div_link <%=sort%>" title="Сортировка"></a></div></th>
											<th>&nbsp;</th>
										</tr>
										<% int i = 0; %>
