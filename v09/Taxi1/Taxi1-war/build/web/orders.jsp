							...
							<div class="txt_content">
								...
								<table class="c_table b_table">
									...
									<tbody>
										<tr>
                                                                                    ...
                                                                                    %>
											<th><div class="th_div b_div">Номер заказа<a href="<%=request.getContextPath()%>/ViewOrderList?field=ID&type=<%=type%>" class="b_div_link <%=sort%>" title="Сортировка"></a></div></th>
											<th><div class="th_div b_div">Дата и время заказа<a href="<%=request.getContextPath()%>/ViewOrderList?field=TIME_ORD&type=<%=type%>" class="b_div_link <%=sort%>" title="Сортировка"></a></div></th>
											<th><div class="th_div b_div">Автомобиль</div></th>
											<th><div class="th_div b_div">Телефон клиента<a href="<%=request.getContextPath()%>/ViewOrderList?field=PHONE&type=<%=type%>" class="b_div_link <%=sort%>" title="Сортировка"></a></div></th>
                                                                                        <th><div class="b_div">Статус<a href="<%=request.getContextPath()%>/ViewOrderList?field=STATUS&type=<%=type%>" class="b_div_link <%=sort%>" title="Сортировка"></a></div></th>
											<th>&nbsp;</th>
										</tr>
										<% int i = 0; %>
								...
								<c:if test="${pageScope.isAdmin}">
									<a href="<%=request.getContextPath()%>/CreateOrder"><img src="<%=request.getContextPath()%>/i/add.png" alt="Добавить"/> <span>Добавить заявку</span></a>
                                                                        ...
                                                                        <a href="<%=request.getContextPath()%>/GetLogServlet?entity=Order"><span class="xml_link"><img src="<%=request.getContextPath()%>/i/list.png" alt="История изменений"/>История изменений</span></a>
								</c:if>
								</p>
