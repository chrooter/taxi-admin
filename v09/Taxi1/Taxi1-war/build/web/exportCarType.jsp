<%@page import="ru.dreamjteam.entity.CarTypeVO"%>
					...
					<div class="box txt_wrap">
						<div class="txt pr zoom after">
							<div class="zoom after pr menu1">
								...
								<div class="menu1_active fl"><div class="menu1_activ_wrap"><div class="menu1_active_inner"><div class="menu1_active_div">Экспорт типов</div></div></div></div>
							</div>
							<div class="txt_content">
                                                            <form action="<%=request.getContextPath()%>/ExportCarType" method="POST" accept-charset="UTF-8">
								...
								<table class="c_table b_table">
									...
									<%  List<CarTypeVO> carTypes = (List<CarTypeVO>) request.getAttribute("carTypes");
