...
<%@page import="java.util.*,ru.dreamjteam.xml.binds.types.*"%>
					...
					<div class="box txt_wrap">
						<div class="txt pr zoom after">
							...
							<div class="txt_content">
								...
								<table class="c_table">
									<tbody>
										...
										<tr class="tr_<%=class_tr%>">
											...
											<td class="links">
												<a href="<%=request.getContextPath()%>/editType.jsp?id=<%=id%>"><img src="i/pen.png" alt=""/></a>
												<a href="<%=request.getContextPath()%>/DeleteCarTypeServlet?id=<%=id%>"><img src="i/del.png" alt=""/></a>
								...
								<p class="add_auto"><a href="<%=request.getContextPath()%>/createType.jsp"><img src="i/add.png" alt=""/> <span>Добавить тип машины</span></a></p>
