						...
						<div class="txt pr zoom after">
							...
							<div class="txt_content">
								...
								<table class="c_table">
									<tbody>
										<tr>
											<th><div class="nobr th_div table_div"><a href="<%=request.getContextPath()%>/ViewOrderListServlet?orderBy=TIME_ORD" alt="">Время отправления</a></div></th>
											<th><div class="nobr th_div table_div"><a href="<%=request.getContextPath()%>/ViewOrderListServlet?orderBy=ADDR_DEP" alt="">Откуда</a></div></th>
											<th><div class="nobr th_div table_div"><a href="<%=request.getContextPath()%>/ViewOrderListServlet?orderBy=ADDR_DEST" alt="">Куда</a></div></th>
											<th><div class="nobr th_div table_div"><a href="<%=request.getContextPath()%>/ViewOrderListServlet?orderBy=PASSENGER" alt="">Количество пассажиров</a></div></th>
                                                                                        <th><div class="nobr th_div table_div"><a href="<%=request.getContextPath()%>/ViewOrderListServlet?orderBy=status" alt="">Статус</a></div></th>
                                                                                        <th><div class="nobr th_div table_div"><a href="<%=request.getContextPath()%>/ViewOrderListServlet?orderBy=cost" alt="">Цена</a></div></th>
										...
										<tr class="tr_<%=class_tr%>">
											...
											<td class="links">
												<a href="<%=request.getContextPath()%>/EditOrderServlet?id=<%=id%>"><img src="<%=request.getContextPath()%>/i/pen.png" alt=""/></a>
												<a href="<%=request.getContextPath()%>/DeleteOrderServlet?id=<%=id%>"><img src="<%=request.getContextPath()%>/i/del.png" alt=""/></a>
								...
								<p class="add_auto"><a href="<%=request.getContextPath()%>/CreateOrderServlet?"><img src="<%=request.getContextPath()%>/i/add.png" alt=""/> <span>Добавить заявку</span></a></p>
