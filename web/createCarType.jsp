					...
					<div class="box txt_wrap">
						<div class="txt pr zoom after">
							<div class="zoom after pr menu1">
								...
								<div class="menu1_active fl"><div class="menu1_activ_wrap"><div class="menu1_active_inner"><div class="menu1_active_div">Добавление типа</div></div></div></div>
							</div>
							<div class="txt_content">
								<form action="<%=request.getContextPath()%>/CreateCarType" method="POST" accept-charset="UTF-8">
									...
									<div class="edit_box"><div class="box">
										...
										<div class="fl edit_side1">
											...
											<div class="edit_side_block">
												...
												<div class="box"><input type="text" class="db edit_txt" name="seatcap" maxlength="6" id="seatcap" value="<c:out value="${requestScope.carType.seatCapacity}"/>"/></div>
											</div>
											<div class="edit_side_block">
